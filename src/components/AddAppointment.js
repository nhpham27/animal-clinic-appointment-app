...
const AddAppointment = (props) => {
    ...
    const [newAppointment, setNewAppointment] = useState(clearForm);
    ...
    const sendNewAppointment = () => {
        ...
        props.onAddAppointment(appointment);
        setNewAppointment(clearForm);
        setToggleForm(false);
    };
                ...
                <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
                    ...
                    <div className="mt-1 sm:mt-0 sm:col-span-2">
                        <input type="date" name="aptDate" id="aptDate"
                            onChange={(e) => setNewAppointment({ ...newAppointment, aptDate: e.target.value })}
                ...
                <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
                    ...
                    <div className="mt-1 sm:mt-0 sm:col-span-2">
                        <input type="time" name="aptTime" id="aptTime"
                            onChange={(e) => setNewAppointment({ ...newAppointment, aptTime: e.target.value })}
                ...
                <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
                    ...
                    <div className="mt-1 sm:mt-0 sm:col-span-2">
                        <textarea id="aptNotes" name="aptNotes" rows="3"
                            onChange={(e) => setNewAppointment({ ...newAppointment, aptNotes: e.target.value })}
                            value={newAppointment.appNotes}
